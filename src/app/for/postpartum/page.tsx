      ...
      <section className="pt-16 pb-12 px-5">
        <div className="max-w-2xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold leading-tight tracking-tight mb-6">
            產後瘦不回來？
            <br />
            <span className="text-[#2a9d6f]">不是你不努力，是荷爾蒙在扯後腿</span>
          </h1>
          <div className="text-lg text-[#6b6560] leading-relaxed mb-10 max-w-lg space-y-2">
            ...
            <p>
              看著鏡子裡的自己，覺得
              <strong className="text-[#2a2520]">這個身體不像自己的</strong>。
            </p>
          </div>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-5 text-base leading-[1.9]">
            ...
            <div className="bg-[#fef9f0] rounded-xl p-5 border-l-4 border-[#e67e22]">
              ...
              <div className="space-y-3 text-[15px] text-[#6b6560]">
                <p>
                  <strong className="text-[#2a2520]">睡眠不足</strong>
                  ：半夜餵奶、哄睡，長期睡眠剝奪讓皮質醇（壓力荷爾蒙）居高不下。皮質醇一高，身體就進入「備戰模式」，拼命囤脂肪。
                </p>
                <p>
                  <strong className="text-[#2a2520]">壓力大</strong>
                  ：照顧新生兒的焦慮、家庭責任、可能的產後情緒低落——這些壓力都會加重皮質醇分泌，進一步推升胰島素。
                </p>
                <p>
                  <strong className="text-[#2a2520]">飲食混亂</strong>
          ...
          <div className="rounded-2xl border border-[#eee9e5] overflow-hidden mb-6 bg-white">
            <div className="p-6">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-sm text-[#a8a29e]">40 歲・文字工作者・媽媽</span>
              </div>
          ...
          <div className="rounded-2xl border border-[#eee9e5] overflow-hidden bg-white">
            <div className="p-6">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-sm text-[#a8a29e]">四個小孩的媽</span>
              </div>
              <div className="flex gap-2 mb-4">
                <span className="text-xs px-2 py-0.5 rounded-full bg-[#27ae60]/10 text-[#27ae60] font-medium">
                  腹部明顯縮小
