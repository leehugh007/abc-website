    ...
    <>
      ...
      <section className="pt-12 pb-8 px-5">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-lg leading-relaxed text-ink border-l-4 border-brand pl-5 font-semibold mb-6">
      ...
      <section className="pb-8 px-5">
        <div className="max-w-2xl mx-auto space-y-5 text-base leading-[1.9]">
          ...
          <div className="bg-info/5 rounded-xl p-5 border-l-4 border-info">
            <p className="font-semibold text-info text-sm mb-2">痛苦的循環</p>
            <p>
              市售減重產品讓我心悸失眠、針灸讓我身體虛弱、三餐蘋果讓我營養不良、激烈斷食讓我代謝更差。這些方式不但讓我反覆失敗，體重甚至變得更重！
            </p>
          </div>

          <div className="bg-success/5 rounded-xl p-5 border-l-4 border-success">
            <p className="font-semibold text-success text-sm mb-2">轉折點</p>
            <p>
          ...
          <blockquote className="py-6 my-2">
            <p className="text-2xl sm:text-3xl font-extrabold leading-snug text-brand-dark">
      ...
      <section className="py-12 px-5">
        <div className="max-w-2xl mx-auto space-y-5 text-base leading-[1.9]">
          ...
          <div className="bg-brand/5 rounded-xl p-5 border-l-4 border-brand">
            <p className="font-semibold text-brand text-sm mb-2">ABC 存在的理由</p>
      ...
      <section className="py-12 px-5 bg-white">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-base leading-relaxed">
            ...
            <Link href="/method" className="text-brand font-semibold hover:underline ml-1">
              了解完整方法 →
            </Link>
          </p>
        </div>
      ...
      <section className="py-12 px-5 bg-surface-green">
        <div className="max-w-2xl mx-auto">
          ...
          {/* 慧敏 */}
          <div className="rounded-2xl border border-edge overflow-hidden mb-8 bg-white">
            <Image
            ...
            <div className="p-6 space-y-3">
              ...
              <p className="text-sm font-semibold text-brand text-center pt-2">
          ...
          <div className="rounded-2xl border border-edge overflow-hidden mb-8 bg-white">
            <div className="grid grid-cols-2 gap-0">
              ...
              <div className="relative">
                ...
                <span className="absolute bottom-2 left-2 bg-success/80 text-white text-xs px-2 py-1 rounded">減重後</span>
              </div>
            </div>
            <div className="p-6">
          ...
          <div className="rounded-2xl border border-edge overflow-hidden mb-8 bg-white">
            ...
            <div className="p-6">
              ...
              <blockquote className="text-[15px] text-subtle border-l-3 border-amber pl-4 mt-2 italic leading-relaxed">
          ...
          <div className="rounded-2xl overflow-hidden border border-edge">
            ...
            <div className="p-5 text-center bg-white">
              ...
              <p className="text-sm text-subtle">因為我們都胖過，我們懂胖過的苦</p>
            </div>
          </div>
        </div>
      </section>
