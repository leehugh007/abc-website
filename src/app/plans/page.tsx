    ...
    <>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={item.day}
                className="flex gap-4 p-4 rounded-xl border border-edge bg-white"
              >
                <div className="shrink-0 w-16 text-center">
                  <span className="text-xs font-bold text-brand bg-surface-green px-2 py-1 rounded-full">
                    {item.day}
                  </span>
                </div>
                <div>
      ...
      <section className="py-16 px-5 bg-white">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-5 max-w-2xl mx-auto">
            {/* 免費版 */}
            <div className="rounded-2xl border border-edge p-6 flex flex-col">
              <div>
            ...
            {/* 完整版 — 推薦 */}
            <div className="rounded-2xl border-2 border-brand p-6 flex flex-col relative">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                <span className="text-xs font-bold text-white bg-brand px-4 py-1 rounded-full">
                  推薦
                </span>
              </div>
              <div>
                ...
                <div className="mb-1">
                  ...
                  <span className="text-sm text-subtle ml-1">/月</span>
                </div>
                ...
                <ul className="space-y-3 text-sm text-subtle">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-ink">無限次</strong>
                      拍餐分析
                    </span>
                  </li>
                  {[
              ...
              <div
                ...
                className={`rounded-xl p-4 ${
                  "highlight" in item && item.highlight
                    ? "bg-surface-green border-2 border-brand"
      ...
      <section className="py-12 px-5">
        <div className="max-w-xl mx-auto">
          <div className="rounded-2xl border border-brand/20 bg-surface-green p-8 text-center">
      ...
      <section className="py-12 px-5 bg-white">
        <div className="max-w-xl mx-auto">
          <div className="rounded-2xl border border-edge p-8">
